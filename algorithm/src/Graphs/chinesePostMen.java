package Graphs;
import java.util.*;
public class chinesePostMen {
	 private chiGraph graph;
	    private chiGraph hGraph;
	    private Set<Integer> visitedVertices;
	    private double exactTime;
	    private double heuristicTime;
	    chinesePostMen(int n) {
	        graph = new chiGraph(n);
	        hGraph = new chiGraph(n);
	        visitedVertices = new HashSet<>();
	    }
	    chinesePostMen(List<Integer> list) {
	        this(list.get(0));
